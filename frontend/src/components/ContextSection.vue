...
<template>
  <div class="grid grid-cols-1 gap-12 text-white">
    <div class="bg-red-700 p-8 rounded-2xl shadow-2xl text-white lg:mt-16">
      <h4 class="font-black text-xl mb-6 uppercase tracking-tighter border-b border-white/20 pb-4">
        Próximos Pasos
      </h4>
